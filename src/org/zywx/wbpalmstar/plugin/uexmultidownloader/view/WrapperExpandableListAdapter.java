...
public class WrapperExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if(convertView != null) {
            final Object tag = convertView.getTag(EUExUtil.getResIdID("fgelv_tag_changed_visibility"));
            ...
            convertView.setTag(EUExUtil.getResIdID("fgelv_tag_changed_visibility"), null);
        }
